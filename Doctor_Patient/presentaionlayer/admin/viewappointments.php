...
<body>
	<h1 style="margin-left:38% ;margin-top:80px"   class="asd"> Appointments </h1>
	<table class="table4">
		<tr>
	...
	<h1 style="margin-left:30% ;margin-top:60px"   class="asd">Send Confirmation Email </h1>
    ...
    <form role="form" method="post" enctype="multipart/form-data" class="form1" style="width: 100%;margin-top:110px;margin-left: -10px;">
       <div classs="xa" style="margin-top:0px">
        ...
        <button type="submit"  id="message" name="sendemail" style="width:300px;height:40px;border-radius: 10px; background:  #38c708; margin-left: 35%;color: white ; font-size: 20px;">Send
               </button>
